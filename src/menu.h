 ...
 * This function creates a new array of menu items based on the notification's actions.
 ...
 */
void menu_set_position(struct notification *n, int index, int x, int y, int width, int height);
 ...
 * @return A pointer to the menu item at the specified coordinates, or NULL if not found
 */
